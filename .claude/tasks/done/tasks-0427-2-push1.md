...
- [x] 1.0 공유 통계 링크 오류 수정 및 생성 결과 노출 안정화
  ...
  - [x] 1.3 회귀 방지 정리 및 에러 핸들링 강화 (커밋 단위)
    **작업 상세:**
    ...
    **참조:** 문서 src/share/PublicShareStatsPage.tsx, src/i18n/locales/en.ts
    - [x] 1.3.T1 예외 케이스 테스트 코드 작성
    - [x] 1.3.T2 npx tsc --noEmit + npm run build 실행 및 검증
    - [x] 1.3.T3 타입/빌드 실패 수정
