...
export const enMessages: Messages = {
  ...
  'history.filter.action.all': 'All',
  'history.filter.tags.label': 'Tags',
  'history.filter.template.label': 'Template',
  'history.filter.reset': 'Reset filters',
  'history.filter.dateLabel': 'Period',
  'history.filter.dateFrom': 'From',
  'history.filter.dateTo': 'To',
  'history.columns.label': 'Columns',
  'history.resultCount': '{count} records',
  'history.pagination.pageInfo': 'Page {page} of {totalPages}',
  'history.pagination.prev': 'Previous',
  'history.pagination.next': 'Next',
  'history.legend.label': 'Row colors',
  'history.hint.titleClick': 'Click a title to see all its settings.',
  ...
  'history.col.datetime': 'Date & time',
  ...
  'history.search.placeholder': 'Search title, URL, tags, UTM, creator',
  'history.search.empty': 'No matching records.',
  'history.detail.shortCode': 'Short code',
  'history.detail.template': 'Template used',
  'history.detail.updatedAt': 'Updated at',
  'history.detail.deletedAt': 'Deleted at',
  'history.detail.noTitle': '(no title)',
  'history.modal.title': 'Short URL details',
  'history.modal.close': 'Close',
  'history.modal.openHint': 'Click to view all settings',
  ...
  'share.manager.summary.expired': '{count} expired',
  ...
  'share.public.section.byTime': 'By time',
  'share.public.section.byContext': 'By context',
  'share.public.section.byLocation': 'By location',
  'share.public.section.list': 'Visits',
  'share.public.byTime.empty': 'No visits to display.',
  'share.public.byContext.referer': 'Referrer',
  'share.public.byContext.os': 'OS',
  'share.public.byContext.browser': 'Browser',
  'share.public.byLocation.country': 'Country',
  'share.public.byLocation.city': 'City',
  'share.public.share.unknown': '(unknown)',
  'share.public.share.direct': '(direct)',
  ...
  'utm.bulk.settings.title': 'Edit settings',
  'utm.bulk.settings.summary': '{count} templates',
  'utm.bulk.settings.expand': 'Open',
  'utm.bulk.settings.collapse': 'Close',
  'utm.bulk.settings.help':
    'Edit the UTM values of the selected templates for this run only. Leave a field empty to omit it.',
  'utm.bulk.settings.edited': 'Edited',
  'utm.bulk.settings.reset': 'Reset',
  'utm.bulk.settings.field.source': 'Source (utm_source)',
  'utm.bulk.settings.field.medium': 'Medium (utm_medium)',
  'utm.bulk.settings.placeholder.source': 'e.g. naver',
  'utm.bulk.settings.placeholder.medium': 'e.g. cpc',
  'utm.bulk.append.title': 'Bulk append / replace',
  'utm.bulk.append.help':
    'Append a word to one UTM field, or replace its value entirely, across all selected templates. e.g. kakao_coop → kakao_coop_0604',
  'utm.bulk.append.fieldLabel': 'Target UTM',
  'utm.bulk.append.wordLabel': 'Value / word',
  'utm.bulk.append.wordPlaceholder': 'e.g. 0604, mktchl3_dday',
  'utm.bulk.append.button': 'Append',
  'utm.bulk.append.needWord': 'Enter a value.',
  'utm.bulk.append.needTemplate': 'Select at least one template.',
  'utm.bulk.append.done': 'Appended to {count} templates.',
  'utm.bulk.replace.button': 'Replace',
  'utm.bulk.replace.done': 'Replaced in {count} templates.',
  'utm.bulk.settings.resetAll': 'Reset all',
  'utm.bulk.settings.perTemplateTitle': 'Per-template settings',
