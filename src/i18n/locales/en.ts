...
export const enMessages: Messages = {
  ...
  'share.manager.create.shortCode.label': 'Short code',
  'share.manager.create.shortCode.placeholder': 'e.g. summer-promo',
  'share.manager.create.shortCode.help': 'Enter the short code that is already registered on the server.',
