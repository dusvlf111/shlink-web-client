export const koMessages = {
  ...
  'share.manager.create.shortCode.label': '단축 코드',
  'share.manager.create.shortCode.placeholder': '예) summer-promo',
  'share.manager.create.shortCode.help': '서버에 등록된 단축 링크의 short code를 입력합니다.',
