export const koMessages = {
  ...
  'history.filter.action.all': '전체',
  'history.filter.tags.label': '태그 필터',
  'history.filter.template.label': '템플릿',
  'history.filter.reset': '필터 초기화',
  'history.filter.dateLabel': '기간',
  'history.filter.dateFrom': '시작일',
  'history.filter.dateTo': '종료일',
  'history.columns.label': '열 설정',
  'history.resultCount': '{count}건',
  'history.pagination.pageInfo': '{page} / {totalPages} 페이지',
  'history.pagination.prev': '이전',
  'history.pagination.next': '다음',
  'history.legend.label': '행 색상',
  'history.hint.titleClick': '제목을 클릭하면 상세 설정을 모두 볼 수 있어요.',
  ...
  'history.action.updated': '수정',
  'history.action.deleted': '삭제',
  'history.search.label': '검색',
  'history.search.placeholder': '제목, URL, 태그, UTM, 생성자 검색',
  'history.search.empty': '검색 결과가 없습니다.',
  'history.detail.shortCode': '단축 코드',
  'history.detail.template': '사용 템플릿',
  'history.detail.updatedAt': '수정 시각',
  'history.detail.deletedAt': '삭제 시각',
  'history.detail.noTitle': '(제목 없음)',
  'history.modal.title': '단축링크 상세',
  'history.modal.close': '닫기',
  'history.modal.openHint': '클릭하면 세부 설정을 모두 볼 수 있어요',

  // 통계 공유 관리 페이지
  'share.manager.title': '통계 공유 링크',
  'share.manager.subtitle':
    '단축 링크의 통계를 외부 사용자에게 안전하게 공유합니다. 공유 링크는 통계 화면만 노출하며, 만료일이 지나면 자동으로 차단됩니다.',
  ...
  'share.manager.create.shortCode.error':
    '단축 링크 목록을 불러오지 못했습니다.',
  ...
  'share.manager.create.serverMissing':
    '서버를 먼저 선택하거나 단축 링크가 있는 서버 경로에서 진입해 주세요.',
  ...
  'share.manager.row.deleteConfirm':
    '이 공유 링크를 종료할까요? 외부 사용자는 더 이상 접근할 수 없게 됩니다.',
  ...
  'utm.builder.multi.label': '링크 목록',
  'utm.builder.multi.placeholder':
    'https://example.com/page1\nhttps://example.com/page2',
  'utm.builder.multi.row.urlPlaceholder': 'https://example.com/page',
  'utm.builder.multi.row.titlePlaceholder': '제목 (선택)',
  'utm.builder.multi.row.tagsPlaceholder': '태그 (선택, 쉼표 구분)',
  'utm.builder.multi.row.addLink': '+ 링크 추가',
  'utm.builder.multi.row.removeLink': '행 삭제',
  ...
  'utm.bulk.step1.help':
    '선택한 템플릿의 utm_* 값을 자동으로 붙여 여러 URL을 한 번에 만듭니다.',
  'utm.bulk.overrideSection.title': '1.5 이번 캠페인 정보 (선택)',
  'utm.bulk.overrideSection.help':
    '비워두면 템플릿에 저장된 값이 그대로 사용됩니다. 입력하면 모든 선택 템플릿에 일괄 적용됩니다.',
  ...
  'utm.bulk.settings.title': '세팅 수정',
  'utm.bulk.settings.summary': '{count}개 템플릿',
  'utm.bulk.settings.expand': '열기',
  'utm.bulk.settings.collapse': '닫기',
  'utm.bulk.settings.help':
    '선택한 템플릿의 UTM 값을 이번 생성에만 수정할 수 있습니다. 비워두면 해당 항목은 제외됩니다.',
  'utm.bulk.settings.edited': '수정됨',
  'utm.bulk.settings.reset': '초기화',
  'utm.bulk.settings.field.source': '소스 (utm_source)',
  'utm.bulk.settings.field.medium': '매체 (utm_medium)',
  'utm.bulk.settings.placeholder.source': '예) naver',
  'utm.bulk.settings.placeholder.medium': '예) cpc',
  'utm.bulk.append.title': '일괄 추가 / 교체',
  'utm.bulk.append.help':
    '선택한 모든 템플릿의 특정 UTM 값에 단어를 덧붙이거나(추가) 값을 통째로 바꿉니다(교체). 예) kakao_coop → kakao_coop_0604',
  'utm.bulk.append.fieldLabel': '대상 UTM',
  'utm.bulk.append.wordLabel': '값 / 단어',
  'utm.bulk.append.wordPlaceholder': '예) 0604, mktchl3_dday',
  'utm.bulk.append.button': '추가하기',
  'utm.bulk.append.needWord': '값을 입력해 주세요.',
  'utm.bulk.append.needTemplate': '템플릿을 1개 이상 선택해 주세요.',
  'utm.bulk.append.done': '{count}개 템플릿에 추가했습니다.',
  'utm.bulk.replace.button': '교체하기',
  'utm.bulk.replace.done': '{count}개 템플릿을 교체했습니다.',
  'utm.bulk.settings.resetAll': '전체 초기화',
  'utm.bulk.settings.perTemplateTitle': '템플릿별 세팅',
  ...
  'utm.bulk.step3.empty':
    '기본 URL을 입력하고 템플릿을 선택한 뒤 만들기 버튼을 눌러주세요.',
  ...
  'utm.bulk.message.invalidUrl':
    'URL 형식을 확인해 주세요. 예) https://example.com/path',
  ...
  'utm.bulk.message.serverMissing':
    '선택된 서버를 찾을 수 없습니다. 서버 경로에서 다시 시도해 주세요.',
  'utm.bulk.message.bulkResult':
    '단축링크 생성 완료: 성공 {success}건, 실패 {fail}건',
  'utm.bulk.message.bulkError':
    '단축링크 생성 중 오류가 발생했습니다. 서버 연결을 확인해주세요.',
  ...
  'utm.template.message.saved': '템플릿이 저장됐습니다.',
  'utm.template.message.updated': '템플릿이 수정됐습니다.',
  'utm.template.error.saveFailed': '템플릿 저장에 실패했습니다',
  'utm.template.error.deleteFailed': '템플릿 삭제에 실패했습니다',

  // UTM 태그 관리
  'utm.tag.title': 'UTM 태그 관리',
  'utm.tag.message.saved': '태그가 저장됐습니다.',
  'utm.tag.message.updated': '태그가 수정됐습니다.',
  'utm.tag.error.saveFailed': '태그 저장에 실패했습니다',
  'utm.tag.error.deleteFailed': '태그 삭제에 실패했습니다',
  ...
  'servers.delete.note':
    '서버의 데이터는 사라지지 않으며, 이 기기에서의 접속 정보만 제거됩니다. 언제든 다시 등록할 수 있습니다.',
  ...
  'servers.form.forwardCredentials':
    '이 서버로 보내는 모든 요청에 자격 증명을 함께 전달합니다.',
